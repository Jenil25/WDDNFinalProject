<%@ Page Title="Movie" Language="C#" AutoEventWireup="true" CodeBehind="moviePage.aspx.cs" MasterPageFile="../Site.Master" Inherits="Try2.MoviePage.moviePage" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        <div class="container-fluid">
            ...
            <!-- Description part -->
            <center>
                <div class="card" style="margin-bottom: 2rem; padding: 5px">
                    <h2 style="font-family: 'Agency FB'">Cast </h2>
                    <br />

                    <center>
                        <asp:ListView ID="ListView1" runat="server" DataSourceID="SqlDataSourceCast" GroupItemCount="3">
                            <LayoutTemplate>
                                <table>
                                    <tr>
                    ...
                    <center>
                        <div class="card" style="height: 300px; width: 500px; border: none; align-self: center">
                    ...
                    <center>
                        <div class="card" style="margin-top: 1rem; height: 75px; width: 500px; align-self: center">
                            ...
                            <center>
                                <div class="row">
                                    ...
                                    <div class="column">
                                        <asp:Button ID="Button1" runat="server" class="btn btn-primary" type="submit" Style="width: 10rem; margin-left: 8rem" Text="Rent Movie" OnClick="Button1_Click" />
                                    </div>
    ...
    <asp:SqlDataSource ID="SqlDataSourceCast" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT * FROM [Cast] WHERE ([movie_id] = @movie_id)">
        <SelectParameters>
